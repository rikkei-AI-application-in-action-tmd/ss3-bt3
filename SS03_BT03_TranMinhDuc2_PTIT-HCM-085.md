...
Mục tiêu của bạn là kiểm tra logic và tìm ra mọi lỗ hổng có thể làm sập chương trình trong đoạn mã Java tính trung bình sau:
...
Ràng buộc yêu cầu:
1. Bạn phải phân tích và chỉ ra cụ thể các trường hợp biên nào (vd: null, rỗng) sẽ làm đoạn code trên phát sinh Exception gì (NullPointerException...).
